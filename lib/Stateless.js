...
exports.makeAPI = function(access_token) {
  ...
  function getRequest(api_url, config, callback) {
    if (!config.responseCode)
      config.responseCode = 200;

    request(
      {
        uri:    getURL(api_url, config.opts),
        method: 'GET',
      },
  ...
  // config.doParse      - if true,  parses the return value as json
  // config.responseCode - if set, checks for this response code
  function postRequest(api_url, config, callback) {
  ...
  api.Groups.index = function(callback) {
    getRequest("/groups", {doParse:true}, callback);
  }

  // List they groups you have left but can rejoin.
  // Callback gets a JSON object of groups.
  api.Groups.former = function(callback) {
    getRequest("/groups/former", {doParse:true}, callback);
  }
  ...
  api.Groups.show = function(id, callback) {
    getRequest("/groups/" + id, {doParse:true}, callback);
  }
  ...
  api.Groups.create = function(opts, callback) {
    if (!opts.name) {
      ...
      postRequest("/groups", {body:opts, responseCode:201, doParse:true}, callback);  
    }
  }
  ...
  api.Groups.update = function(id, opts, callback) {
    postRequest("/groups/" + id + "/update", {body:opts, responseCode:200, doParse:true}, callback);  
  }
  ...
  api.Groups.destroy = function(id, callback) {
    postRequest("/groups/" + id + "/destroy", {}, callback);
  }
  ...
  api.Members.add = function(id, opts, callback) {
    if (!opts.members || opts.members.length < 1) {
      ...
      postRequest("/groups/" + id + "/members/add", {body:opts, responseCode:202, doParse:true}, callback);       
    }
  }
  ...
  api.Members.results = function(id, results_id, callback) {
    getRequest("/groups/" + id + "/members/results/" + results_id, {opts:opts, doParse:true}, callback);  
  }
  ...
  ***********************************************************************/
  ...
  api.Messages.index = function(id, opts, callback) {
    getRequest("/groups/" + id + "/messages", {opts:opts, doParse:true}, callback);  
  }
  ...
  api.Messages.create = function(id, opts, callback) {
    if (!opts || !opts.message || !opts.message.source_guid) {
      ...
      postRequest("/groups/" + id + "/messages", {body:opts, responseCode:201, doParse:true}, callback);     
    }
  }
  ...
  ***********************************************************************/
  ...
  api.Likes.create = function(group_id, message_id, callback) {
    postRequest("/messages/" + group_id + "/" + message_id + "/like", {}, callback);
  }

  // Unlike a liked message.
  // Callback gets a statusCode of 200
  api.Likes.destroy = function(group_id, message_id, callback) {
    postRequest("/messages/" + group_id + "/" + message_id + "/unlike", {}, callback);
  }
  ...
  ***********************************************************************/
  ...
  api.Bots.create = function(name, group_id, opts, callback) {
    var payload = {
      "bot[name]": name,
    ...
    postRequest("/bots", {form:payload, responseCode:201, doParse:true}, callback);
  }
  ...
  api.Bots.post = function(bot_id, text, opts, callback) {
    var payload = {
      bot_id: bot_id,
      text: text
    }
    ...
    postRequest("/bots/post", {form:payload, responseCode:202}, callback);
  }

  // List bots you have created
  api.Bots.index = function(callback) {
    getRequest("/bots", {doParse:true}, callback);
  }

  // Remove a bot that you have created
  //  bot_id [required]   - string, the id of the bot
  api.Bots.destroy = function(bot_id, callback) {
    postRequest("/bots/destroy", {form:{"bot_id":bot_id}, responseCode:200}, callback);  
  }
  ...
  ***********************************************************************/
  ...
  api.Users.me = function(callback) {
    getRequest("/users/me", {doParse:true}, callback);
  }
